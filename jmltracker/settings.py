...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # Puts DEMO_MODE in front of every template, including the
                # login page, which contrib.auth renders with no project view
                # of its own to add it.
                "tracker.context_processors.demo_mode",
            ],
        },
    },
]
